...
define gui.text_font = "Vollkorn.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "Vollkorn-SemiBoldItalic.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "Vollkorn.ttf"
...
## 1.0 — низ.
define gui.textbox_yalign = 0.995
...
## порядку.
define gui.namebox_borders = Borders(15, 0, 15, 0)
...
define gui.choice_button_text_idle_color = '#282828'
