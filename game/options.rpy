...
define config.name = _("The mystery behind the mask")
...
define gui.about = _p("""
Визуальная новелла с элементами романтики, приключений и драмы.

Париж в опасности!
Новый злодей по имени Мираж использует свои силы, чтобы создавать иллюзии, раскрывающие самые сокровенные тайны людей. Город охвачен паникой, и только Леди Баг и Супер-Кот могут остановить его. Но в этой битве им предстоит столкнуться не только с врагом, но и с собственными страхами, тайнами и чувствами, которые они так тщательно скрывали друг от друга.

Игроку предстоит взять на себя роль Маринетт (Леди Баг) или Адриана (Супер-Кота), чтобы раскрыть тайны, справиться с иллюзиями и, возможно, найти в себе силы признаться в своих чувствах. Каждый выбор будет влиять на развитие сюжета и отношения между героями, приводя к одной из нескольких концовок.
...
define build.name = "TheMysteryBehindTheMask"
...
define config.save_directory = "TheMysteryBehindTheMask-1737800595"
